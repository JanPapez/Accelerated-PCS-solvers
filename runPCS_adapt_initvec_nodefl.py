...
this script runs standard PCG solver with particular choice of the starting guess
    for a sequence of PCS problems
"""
...
param.scalen = 100   # noise scaling, set 0 for no noise
param.niter = 200                  #
...
for Beta_i in np.arange(Beta_init, param.Betas_index):
    ...
    xPCG, res_normPCG, normb = PCG_BDprec(fullA, data, xPCG, param.niter,
